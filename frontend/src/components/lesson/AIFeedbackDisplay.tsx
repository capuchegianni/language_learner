    ...
    <div>
      ...
      <div className="glass-card" style={{ marginBottom: '1.25rem' }}>
        ...
        {userSubmission?.ex1 && (
          <div style={{ background: 'rgba(99, 102, 241, 0.08)', padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', marginBottom: '0.75rem', borderLeft: '3px solid var(--accent-secondary)' }}>
            ...
            <p className="kr-text" style={{ fontSize: '0.9rem', whiteSpace: 'pre-wrap', lineHeight: 1.5 }}>{userSubmission.ex1}</p>
          </div>
        )}
      ...
      <div className="glass-card" style={{ marginBottom: '1.25rem' }}>
        ...
        {userSubmission?.ex2 && (
          <div style={{ background: 'rgba(99, 102, 241, 0.08)', padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', marginBottom: '0.75rem', borderLeft: '3px solid var(--accent-secondary)' }}>
            <div style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--accent-secondary)', marginBottom: '0.25rem' }}>Your Answer:</div>
            <p className="kr-text" style={{ fontSize: '0.9rem', whiteSpace: 'pre-wrap', lineHeight: 1.5 }}>{userSubmission.ex2}</p>
          </div>
        )}
      ...
      <div className="glass-card" style={{ marginBottom: '1.25rem' }}>
        ...
        {lessonContent?.exercise3?.textToTranslate && (
          <div style={{ background: 'rgba(15,23,42,0.6)', border: '1px solid var(--border-color)', padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', marginBottom: '0.75rem' }}>
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--text-primary)', fontStyle: 'italic', whiteSpace: 'pre-wrap', lineHeight: 1.5 }}>
              "{lessonContent.exercise3.textToTranslate}"
            </p>
          </div>
        )}
        ...
        {userSubmission?.ex3 && (
          <div style={{ background: 'rgba(99, 102, 241, 0.08)', padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', marginBottom: '0.75rem', borderLeft: '3px solid var(--accent-secondary)' }}>
            <div style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--accent-secondary)', marginBottom: '0.25rem' }}>Your Answer:</div>
            <p className="kr-text" style={{ fontSize: '0.9rem', whiteSpace: 'pre-wrap', lineHeight: 1.5 }}>{userSubmission.ex3}</p>
          </div>
        )}
